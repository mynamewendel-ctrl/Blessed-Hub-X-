...
local Icons = {
    ...
    blessed   = "rbxassetid://137601480983962", -- Logo do Hub (ícone da direita)
}
...
function BlessedHubX:Window(GuiConfig)
    ...
    GuiConfig.Footer       = GuiConfig.Footer or "Blessed Hub X :3"
    GuiConfig.Color        = GuiConfig.Color or Color3.fromRGB(255, 105, 180)
    GuiConfig["Tab Width"] = GuiConfig["Tab Width"] or 120
    GuiConfig.Version      = GuiConfig.Version or 1
    GuiConfig.Logo         = GuiConfig.Logo or Icons.blessed  -- Logo do hub (ícone da direita)
    ...
    CardGlow.Size = UDim2.new(1, 55, 1, 55)
    CardGlow.ZIndex = 1
    CardGlow.Parent = DropShadowHolder
    ...
    spawn(function()
        ...
        while CardGlow and CardGlow.Parent do
            angle = (angle + 1) % 360
            CardGlow.Rotation = angle
            task.wait(0.03)
        end
    end)

    DropShadowHolder.Position = UDim2.new(0, (BlessedHubX.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (BlessedHubX.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    -- Ícone da logo no canto superior direito
    local LogoIcon = Instance.new("ImageLabel")
    LogoIcon.Image = GuiConfig.Logo
    LogoIcon.Size = UDim2.new(0, 24, 0, 24)
    LogoIcon.Position = UDim2.new(1, -70, 0.5, -12)
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("BlessedHubX") then
            BlessedHubX:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Title.Text = "Blessed Hub X Window"
        Title.TextSize = 22
    ...
    function Tabs:AddTab(TabConfig)
        ...
        -- Função para adicionar separador de texto
        local function AddTextSeparator(title)
            title = title or "SECTION"
            
            local Separator = Instance.new("Frame")
            Separator.Name = "TextSeparator"
            Separator.Parent = ScrolLayers
            Separator.BackgroundTransparency = 1
            Separator.Size = UDim2.new(1, 0, 0, 24)
            Separator.LayoutOrder = 1

            local LineLeft = Instance.new("Frame")
            LineLeft.Parent = Separator
            LineLeft.BackgroundColor3 = GuiConfig.Color
            LineLeft.BackgroundTransparency = 0.5
            LineLeft.BorderSizePixel = 0
            LineLeft.Size = UDim2.new(0.3, -10, 0, 1)
            LineLeft.Position = UDim2.new(0, 5, 0.5, 0)

            local LineRight = Instance.new("Frame")
            LineRight.Parent = Separator
            LineRight.BackgroundColor3 = GuiConfig.Color
            LineRight.BackgroundTransparency = 0.5
            LineRight.BorderSizePixel = 0
            LineRight.Size = UDim2.new(0.3, -10, 0, 1)
            LineRight.Position = UDim2.new(0.7, 5, 0.5, 0)
        ...
        -- Função para adicionar linha divisória simples
        ...
        -- Função para criar um card com borda animada
        local function CreateCard(content)
            local Card = Instance.new("Frame")
            Card.Name = "AnimatedCard"
            ...
            CardInner.Name = "CardInner"
            CardInner.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            CardInner.BackgroundTransparency = 0.935
            CardInner.BorderSizePixel = 0
            CardInner.Size = UDim2.new(1, -2, 1, -2)
            CardInner.Position = UDim2.new(0, 1, 0, 1)
            CardInner.Parent = Card

            local CardCorner = Instance.new("UICorner")
            CardCorner.CornerRadius = UDim.new(0, 6)
            CardCorner.Parent = CardInner
            ...
            CardGlow.BackgroundTransparency = 1
            CardGlow.BorderSizePixel = 0
            CardGlow.Size = UDim2.new(1, 10, 1, 10)
            CardGlow.Position = UDim2.new(0, -5, 0, -5)
            ...
            return CardInner, Card
        end

        -- Funções para adicionar elementos diretamente (sem Sections)
        local TabItems = {}
        
        function TabItems:AddTextSeparator(title)
            return AddTextSeparator(title)
        end
        ...
        function TabItems:AddParagraph(ParagraphConfig)
            ...
            local CardInner, Card = CreateCard()
            CardInner.Size = UDim2.new(1, -2, 0, 46)

            local iconOffset = 10
            if ParagraphConfig.Icon and ParagraphConfig.Icon ~= "" then
                local IconImg = Instance.new("ImageLabel")
                IconImg.Size = UDim2.new(0, 20, 0, 20)
                IconImg.Position = UDim2.new(0, 8, 0, 12)
                IconImg.BackgroundTransparency = 1
                IconImg.Name = "ParagraphIcon"
                IconImg.Parent = CardInner
            ...
            ParagraphTitle.Parent = CardInner
            ...
            ParagraphContent.Parent = CardInner

            local function UpdateSize()
                local textHeight = ParagraphContent.TextBounds.Y
                if textHeight < 14 then textHeight = 14 end
                
                ParagraphContent.Size = UDim2.new(1, -iconOffset-10, 0, textHeight)
                
                local totalHeight = textHeight + 33
                if ParagraphConfig.ButtonText then
                    totalHeight = totalHeight + 35
                end
                
                CardInner.Size = UDim2.new(1, -2, 0, totalHeight)
                Card.Size = UDim2.new(1, 0, 0, totalHeight + 2)
            end
            ...
            if ParagraphConfig.ButtonText then
                local Button = Instance.new("TextButton")
                Button.Position = UDim2.new(0, 10, 0, ParagraphContent.AbsoluteSize.Y + 30)
                ...
                Button.Text = ParagraphConfig.ButtonText
                Button.Parent = CardInner
                ...
                if ParagraphConfig.ButtonCallback then
                    Button.MouseButton1Click:Connect(ParagraphConfig.ButtonCallback)
                end
            end
            ...
            -- Atualizar layout do ScrolLayers
        ...
        function TabItems:AddPanel(PanelConfig)
            ...
            local CardInner, Card = CreateCard()
            CardInner.Size = UDim2.new(1, -2, 0, baseHeight)
        ...
        function TabItems:AddButton(ButtonConfig)
            ...
            local CardInner, Card = CreateCard()
            CardInner.Size = UDim2.new(1, -2, 0, 40)
        ...
        function TabItems:AddToggle(ToggleConfig)
            ...
            ToggleContent.Parent = CardInner

            if ToggleConfig.Title2 ~= "" then
                CardInner.Size = UDim2.new(1, -2, 0, 57)
            ...
            FeatureStroke.Color = Color3.fromRGB(255, 255, 255)
            FeatureStroke.Thickness = 2
            FeatureStroke.Transparency = 0.9
            ...
            function ToggleFunc:Set(Value)
                ...
                if Value then
                    ...
                    TweenService:Create(FeatureStroke, TweenInfo.new(0.2), { Color = GuiConfig.Color, Transparency = 0 }):Play()
                    ...
                    TweenService:Create(FeatureStroke, TweenInfo.new(0.2), { Color = Color3.fromRGB(255, 255, 255), Transparency = 0.9 }):Play()
        ...
        function TabItems:AddSlider(SliderConfig)
            ...
            SliderContent.Parent = CardInner
            ...
            DraggableCorner.CornerRadius = UDim.new(0, 2)
            ...
            function SliderFunc:Set(Value)
                ...
                SliderDraggable.Size = UDim2.new(percent, 0, 0, 1)
        ...
        function TabItems:AddInput(InputConfig)
        ...
        function TabItems:AddDropdown(DropdownConfig)
            ...
            DropdownTitle.Parent = CardInner
            ...
            DropdownContent.Parent = CardInner
            ...
            DropdownButton.Parent = CardInner
            ...
            SelectOptionsFrame.Parent = CardInner

            local OptionsCorner = Instance.new("UICorner")
            OptionsCorner.CornerRadius = UDim.new(0, 4)
            OptionsCorner.Parent = SelectOptionsFrame
